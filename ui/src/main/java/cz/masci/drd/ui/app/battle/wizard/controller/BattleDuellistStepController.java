...
public class BattleDuellistStepController extends SimpleLeafStep {
  public BattleDuellistStepController() {
    super("Bojovníci skupiny", new TestBattleStepViewBuilder("Bojovníci skupiny").build());
  }
}
