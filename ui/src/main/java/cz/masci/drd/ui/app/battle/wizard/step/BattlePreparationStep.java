...
public class BattlePreparationStep extends SimpleCompositeStep {
  ...
  public HierarchicalStep next() {
    if (getCurrentIdx() < 0) {
      clearSteps();
      addStep(new BattlePreparationSummaryStep(FXCollections.observableList(interactor.getPreparationSummary())));
    }
