...
CREATE TABLE ADVENTURE (
    ADVENTURE_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL PRIMARY KEY,
    NAME VARCHAR(255) NOT NULL
);

CREATE TABLE WEAPON (
    WEAPON_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL PRIMARY KEY,
    NAME VARCHAR(255) NOT NULL,
...
CREATE TABLE ROOM (
    ROOM_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL PRIMARY KEY,
    NAME VARCHAR(255) NOT NULL,
    ADVENTURE_ID BIGINT CONSTRAINT adventure_foreign_key REFERENCES Adventure
);